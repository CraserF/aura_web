...
export const SLIDE_LAYOUT_REGISTRY: Record<SlideLayoutId, SlideLayoutDefinition> = {
  ...
  'big-statement': {
    ...
    matchKeywords: ['big-statement', 'belief', 'assertion', 'manifesto', 'one-thing', 'insight', 'problem', 'tension', 'gap', 'challenge', 'evidence strip'],
    slots: [
      eyebrow(false),
      { id: 'statement', label: 'Statement', required: true, maxChars: 140, maxWords: 20, minFontSizePx: 48, description: 'The single big idea. Very large text.' },
    ...
    qualityRules: [
      'Statement text must be 48px minimum.',
